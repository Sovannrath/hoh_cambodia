<aside id="left-panel">
  ...
  {{--  NOTE: Notice the gaps after each icon usage <i></i>.. Please note that these links work a bit different than traditional href="" links. See documentation for details. --}}
    <ul>
      ...
      {{-- Notification --}}
      <li>
          <a href="#" title="ទំនិញទាំងអស់"><i class="fa fa-lg fa-fw fa-suitcase"></i> <span class="menu-item-parent">ទំនិញទាំងអស់</span></a>
          <ul>
      ...
      <li class="{{ (\Request::route()->getName() == 'category') ? 'active' : '' }}">
        <a href="{{ route('category') }}" title="ប្រភេទទំនិញ"><i class="fa fa-lg fa-fw fa-cog"></i> <span class="menu-item-parent">ប្រភេទទំនិញ</span></a>
      </li>
    </ul>
  </nav>
  {{-- Minify Menu --}}
